...
Users can also generate bootstrapped confidence interval plots by specifying 'bootstrap_time = TRUE' in the growth_curve_model_fit() function and specify 'plot_type = 4' in the growth_vs_time_plot() function.
...
-   Anand Panigrahy (Package Author and Developer) - [anand_panigrahy\@dfci.harvard.edu](mailto:anand_panigrahy@dfci.harvard.edu)

-   Sonam Bhatia (Package Author) - [sonam_bhatia\@dfci.harvard.edu](mailto:sonam_bhatia@dfci.harvard.edu)

-   Thomas Quinn (Data Contributor) - [thomasw_quinn\@dfci.harvard.edu](mailto:thomasw_quinn@dfci.harvard.edu)

-   Aniket Shetty (Reviewer) - [aniket_shetty\@dfci.harvard.edu](mailto:aniket_shetty@dfci.harvard.edu)

-   Keith Ligon (Funder and Principal Investigator) - [keith_ligon\@dfci.harvard.edu](mailto:keith_ligon@dfci.harvard.edu)
